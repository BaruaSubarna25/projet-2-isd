...
Le meilleur nombre d’attributs est d’environ 6 à 7, car c’est à ce niveau que la performance sur le jeu de test est maximale.
...
---
# VOTRE CODE ICI
col_selected = ranked_columns[0:7]  # ou le nombre optimal que vous avez choisi
...
La paire d’attributs G-(R+B)/2 et C/V donne les meilleures performances en analyse multi-variée. 
