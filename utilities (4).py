...
def crop_image(img: Image.Image, crop_size: int = 100) -> Image.Image:
...
def crop_around_center(img, center, crop_size=80):
    """Crop a PIL image to crop_size x crop_size."""
...
def analyze_model_experiments(result_df):
    ...
    overfitted  = tebad & ~trbad  # bon train, mauvais test
    underfitted = tebad &  trbad  # mauvais train ET mauvais test
